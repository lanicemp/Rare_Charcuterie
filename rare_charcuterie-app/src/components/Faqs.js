    ...
    return (
      <div className="faqs">
        ...
        <p>
          ...
          kitchen space is held to the highest health standards and we have the
          following procedures in place:
          <br></br>
          <li>
          
            Multiple sanitized Work stations are set up , with different sets of
            gloves and masks to prevent and eliminate cross contamination.
          </li>
          <li>
            We use disposable boxes to offer you different sizing options and to
          ...
          <li>
            We offer contact-less pick up and delivery to avoid your box coming
            into contact with multiple environments and/or people.
          </li>
          <br></br>
        </p>
        </div>
